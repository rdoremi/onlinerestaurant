...
import com.cjh.online.restaurant.alipay.AlipayConfig;
import com.cjh.online.restaurant.service.AlipayService;
...
public class AlipayServiceImpl implements AlipayService {
    ...
    public String refund(String outTradeNo,String refundReason,Integer refundAmount,String outRequestNo) throws AlipayApiException {
        ...
        System.out.println(outRequestNo+" "+refundAmount);
        /** 调取接口*/
        alipayRequest.setBizContent("{\"out_trade_no\":\""+ outTradeNo +"\","
